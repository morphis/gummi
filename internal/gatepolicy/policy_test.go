...
func TestDecide(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			in: Input{
				Stage: domain.StageVerify, Kind: domain.KindFeature,
				Verdict: verdict.Blocked, Gate: domain.GateAttended, WorkStage: workStage,
			},
			want: Outcome{Action: Park, Stage: domain.StageVerify, Reason: "verify-blocked"},
		},
		{
		...
		// --- environment halts: never a retry target ----------------------
		{
			...
			in: Input{
				...
				Halt: HaltSandboxRefusal, Gate: domain.GateAttended, WorkStage: workStage,
			},
		...
		},
		{
			...
			in: Input{
				Stage: domain.StageVerify, Kind: domain.KindFeature,
				Verdict: verdict.Pass, Halt: HaltSandboxRefusal, Gate: domain.GateAttended, WorkStage: workStage,
			},
