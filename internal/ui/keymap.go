...
func (m *Shell) boardBindings() []binding {
	...
	bs := []binding{
		...
		{key: "n", label: "new", help: "new card (feature, bug or research; paste an issue link to import it)", bar: true},
		{key: "B", label: "bug", help: "new card, bug preset"},
		{key: "R", label: "research", help: "new card, research preset"},
		{key: "I", label: "ingest", help: "ingest a spec into features"},
		{key: "G", label: "import", help: "new bug from a GitHub issue — browse the repo's issues"},
